...
@Component({
	...
	selector: 'kt-approve-leave-request-view-dialog',
	templateUrl: './approve-leave-request-view.dialog.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	encapsulation: ViewEncapsulation.None
})
export class ApproveLeaveRequestViewDialogComponent implements OnInit, OnDestroy {
...
constructor(public dialogRef: MatDialogRef<ApproveLeaveRequestViewDialogComponent>,
