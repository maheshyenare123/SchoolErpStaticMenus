...
@Component({
	...
	selector: 'kt-apply-leave-edit-dialog',
	templateUrl: './apply-leave-edit.dialog.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	encapsulation: ViewEncapsulation.None
})
export class ApplyLeaveEditDialogComponent implements OnInit, OnDestroy {
