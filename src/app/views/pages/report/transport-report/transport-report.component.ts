...
import { RouteModel, VehicleModel, RouteService, VehicleService } from 'src/app/core/transport';

@Component({
  selector: 'kt-transport-report',
...
export class TransportReportComponent implements OnInit {
  ...
  displayedColumns = ['classSection','admissionNo', 'name' , 'contact', 'fatherName', 'fatherPhone', 'motherName', 'motherPhone', 'routeTitle', 'vehicleNo', 'driverName', 'driveContact', 'fare'];
