...
@Component({
  selector: 'kt-balance-fees-report',
  templateUrl: './balance-fees-report.component.html',
  styleUrls: ['./balance-fees-report.component.scss']
})
export class BalanceFeesReportComponent implements OnInit {
  
  // Table fields
  dataSource: StudentsDataSource;
  displayedColumns = ['class','section', 'name','admissionNo', 'rollNo', 'fatherName','totalFees','discount', 'fine', 'paidFees', 'balance'];
