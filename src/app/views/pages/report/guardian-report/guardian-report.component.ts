...
@Component({
  selector: 'kt-guardian-report',
  templateUrl: './guardian-report.component.html',
  styleUrls: ['./guardian-report.component.scss']
})
export class GuardianReportComponent implements OnInit {

  // Table fields
  dataSource: StudentsDataSource;
  displayedColumns = ['classSection','admissionNo', 'name' , 'contact','guardianName', 'guardianRelation', 'guardianPhone', 'fatherName', 'fatherPhone', 'motherName', 'motherPhone'];
