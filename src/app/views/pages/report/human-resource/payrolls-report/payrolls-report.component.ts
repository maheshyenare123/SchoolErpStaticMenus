...
@Component({
  selector: 'kt-payrolls-report',
  templateUrl: './payrolls-report.component.html',
  styleUrls: ['./payrolls-report.component.scss']
})
export class PayrollsReportComponent implements OnInit {
