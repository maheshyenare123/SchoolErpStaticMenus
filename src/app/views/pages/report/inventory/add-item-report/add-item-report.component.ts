...
@Component({
  selector: 'kt-add-item-report',
  templateUrl: './add-item-report.component.html',
  styleUrls: ['./add-item-report.component.scss']
})
export class AddItemReportComponent implements OnInit {
// Table fields
dataSource: ItemStocksDataSource;
//  dataSource = new MatTableDataSource(ELEMENT_DATA);


displayedColumns = ['id', 'itemName', 'itemCategory', 'itemSupplier', 'itemStore', 'quantity', 'purchasePrice', 'date'];
